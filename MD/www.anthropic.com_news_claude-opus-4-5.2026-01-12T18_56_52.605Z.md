...
Claude Code is also now [available in our desktop app](https://claude.ai/redirect/website.v1.d358677c-48d9-4388-8baf-bd9f272951fc/download), letting you run multiple local and remote sessions in parallel: perhaps one agent fixes bugs, another researches GitHub, and a third updates docs.
...
[Claude Code on desktop](https://www.youtube.com/watch?v=zrcCS9oHjtI)
